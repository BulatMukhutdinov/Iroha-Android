...
public class Transaction {
  ...
  public boolean addSignature(SWIGTYPE_p_detail__PolymorphicWrapperT_Signature_t signature) {
    return irohaJNI.Transaction_addSignature(swigCPtr, this, SWIGTYPE_p_detail__PolymorphicWrapperT_Signature_t.getCPtr(signature));
  }
